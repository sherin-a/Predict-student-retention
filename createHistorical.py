...
equivalence=pd.read_csv("C:\\Users\\MALAVIKA P PILLAI\\Documents\\Studies\\EDM\\datasets\\equivalences.csv", sep = ';', names=colnames_eq, encoding = "ISO-8859-1" )

colnames_ac = ['idStud','idStatus','Situation','year_sem','idCurr','irrelevant1','irrelevant2']
accompainments=pd.read_csv("C:\\Users\\MALAVIKA P PILLAI\\Documents\\Studies\\EDM\\datasets\\accompaniments.csv", sep = ';', names=colnames_ac,encoding = "ISO-8859-1")

colnames_his = ['idStud','year_sem','idDisc','grade','grade_sv','frequency','situation_discipline']
historical=pd.read_csv("C:\\Users\\MALAVIKA P PILLAI\\Documents\\Studies\\EDM\\datasets\\historical.csv", sep = ';', names=colnames_his)
...
studId_graduated = accompainments[accompainments['idStatus'] == "Formado"].idStud.unique()
...
for stud in studId_graduated:
    ...
    if s_curr in vertices :
        fileName = "C:\\Users\\MALAVIKA P PILLAI\\Documents\\Studies\\EDM\\students\\graphStud"+str(stud)+"_"+str(s_curr.replace(" ","").replace(".",""))+".txt"
        g = open(fileName, "w")
